...
module.exports.run = async (Client, interaction, slasherrorlog) => {
    ...
    try {
        ...
        if(user.bot == true) return interaction.reply({content: `**You cannot delete level file of a bot since they don't have any.**`, ephemeral: true})
        ...
        const embed = new discord.MessageEmbed()
            .setColor(`GREEN`)
            .setDescription(`**Deleted User Level of ${user} successfully.**`)
        ...
        const modembed = new discord.MessageEmbed()
            .setColor('RED')
            .setTitle('Action Took: Level deleted')
